...
OutputBaseFilename=yutovo-desktop_1.5.1-1_win10_amd64
Compression=lzma
...
Source: "c:\Lang\Programs\yutovo\yutovo-library\*"; DestDir: "{app}\library"; Flags: ignoreversion recursesubdirs; Attribs: readonly
